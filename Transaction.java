...
public class Transaction implements Comparable<Transaction> {
   ...
   static class WhoOrder implements Comparator<Transaction>{
   ...
   public static void main(String[] args) {
      final int numOfLines = 4;  // number of lines in the input file (either 10, 100, or 100000)
      In in = new In("4records.txt");  // input files: 10records.txt, 100records.txt, or 1000000records.txt
